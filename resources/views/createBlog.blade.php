...
<script>
    ...
    <div class="card">
        ...
        <div class="card-header" dir="rtl">
            <div aria-label="breadcrumb">
                <ol class="breadcrumb bg-inverse-primary justify-content-between">
                    <li class="breadcrumb-item"><a href="#">    المٌدونة</a>
                        <span class="breadcrumb-item active" aria-current="page"> /  إضافة مقال </span>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <form method="POST" action="storeBlog" enctype="multipart/form-data" name="my-form" onsubmit="validateFrom('my-form',event)">
                @csrf
                <div class="card-body row" >
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div id="quillExample2" class="quill-container text-right"></div>
