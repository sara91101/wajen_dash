                    ...
                    <div class="form-group col-lg-4">
                        ...
                        <select name="governorate_id" id="governate" class="form-select text-right" required>
                            ...
                            @foreach ($governorates as $g)
                                <option value={{$g["id"] }} class="{{ $g['city_id'] }}" @if($g['id'] == $customer['governorate_id']) selected @endif>{{ $g["ar_name"] }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-lg-4">
            ...
            <fieldset>
                <div class="form-card row text-right" dir="rtl">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input type="date" value="{{ date('Y-m-d',strtotime($customer['subscription_start_at'])) }}" name="start_date" class="form-control text-right" required>
                    </div>

                    <div class="form-group col-lg-6">
                        <label for="exampleInputUsername1"><i class="mdi mdi-star text-danger"></i> تاريخ نهاية الإشتراك </label>
                        <input type="date" value="{{ date('Y-m-d',strtotime($customer['subscription_end_at'])) }}" name="end_date" class="form-control text-right" required>
                    </div>
