...
class UnitController extends Controller
{
    ...
    {
        $client = new Client();
        $url="https://backend.skilltax.sa/api/v1/inventory-units/$request->Unit_id";
    ...
    {
        $client = new Client();
        $url="https://backend.skilltax.sa/api/v1/inventory-units/activate/$Unit_id";
    ...
    {
        $client = new Client();
        $url="https://backend.skilltax.sa/api/v1/inventory-units/inActivate/$Unit_id";
    ...
    {
        $client = new Client();
        $url="https://backend.skilltax.sa/api/v1/inventory-units/archive/$Unit_id";
